...
public class Secrets
{
    ...
    public Secrets(string dataConnectionString, string eventHubConnectionString)
    {
        ...
        EventHubConnectionString = eventHubConnectionString ?? throw new ArgumentException("Must provide an eventHubConnectionString", nameof(eventHubConnectionString));
    }
